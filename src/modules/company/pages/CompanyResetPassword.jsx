...
const CompanyResetPassword = () => {
  ...
  useEffect(() => {
    ...
    if (tokenFromUrl && emailFromUrl) {
      ...
      setEmail(decodeURIComponent(emailFromUrl)); // Decode the email
            ...
            <div className="text-center py-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3 px-4 bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white rounded-lg font-semibold hover:opacity-90 transition"
                >
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 hover:border-gray-400 transition"
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition ${
