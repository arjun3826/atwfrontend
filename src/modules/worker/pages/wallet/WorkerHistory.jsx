...
const WorkerHistory = () => {
  ...
  const { loading, history, pagination, fetchWalletHistory } =
    useWorkerWallet();
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                View and manage all your wallet activities
              </p>
            </div>
          </div>
          ...
          {loading ? (
                ...
                {history.map((tx, idx) => (
                  ...
                  >
                        ...
                        <p className="text-sm text-gray-500 font-medium">
                          {tx.type === "credit"
                            ...
                            : tx.source === "permanent_deduction"
                              ...
                              : tx.withdrawal_method === "auto"
                                ? `Auto payout (${tx.withdrawal_frequency}) to linked bank`
                    ...
                    <div className="text-right">
                      <p
                        className={`text-xl font-black ${tx.type === "credit" ? "text-green-600" : "text-gray-900"}`}
                      >
                        {tx.type === "credit" ? "+" : "-"}
            ...
            <div className="py-20 flex flex-col items-center text-center px-6">
              ...
              <p className="text-gray-500 max-w-xs mt-1">
                We couldn't find any records for the selected month and year.
