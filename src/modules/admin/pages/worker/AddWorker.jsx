...
import SingleAddWorkerForm from "../../components/worker/SingleAddWorkerForm";

import { bulkUploadWorkers } from "../../../../api/admin/adminWorkerAPI";
...
const AddWorker = () => {
  ...
  if (!hasPermission("workers", "create")) {
    return (
      <div className="min-h-screen bg-gray-50 p-4 flex items-center justify-center">
        <div className="bg-white rounded-lg p-8 text-center max-w-md shadow-sm">
          ...
          <p className="text-gray-600 mb-6">
            You don't have permission to add a worker.
          </p>
  ...
  const handleBulkUpload = async () => {
    ...
    try {
      ...
      Swal.fire({
        title: "Uploading...",
        text: "Please wait while workers are uploaded.",
      ...
      const response = await bulkUploadWorkers(formData);
...
`,
      ...
      Swal.fire({
        ...
        text: response?.message || "Workers uploaded successfully.",
      });
      // Swal.fire({
      //   icon: "success",
      //   title: "Upload Successful",
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Upload an Excel file to add multiple workers at once.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-4 justify-center mb-6">
            ...
            <a
              href="https://anytimework.in/anytimework/storage/app/public/excel-import/worker_bulk_upload_sample.xlsx"
              target="_blank"
