      ...
      <div className="max-w-lg w-full">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 mt-2">
            Enter your agent email and we'll send you a reset link
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 transition ${
                      emailError
                        ? "border-red-500"
                ...
                <button
                  ...
                  className={`w-full py-3 px-4 rounded-lg font-semibold text-white transition-all duration-200 ${
                    loading
                      ...
                      : "bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 hover:from-teal-700 hover:via-cyan-700 hover:to-blue-700 hover:shadow-lg"
                  }`}
                >
                  {loading ? (
