...
import { useEditCompany } from "../../agenthooks/useAgentCompanyEdit";
    ...
    try {
      ...
      if (result?.success) {
        ...
        Swal.fire({
          ...
          title: "Failed",
          text:
            result?.message || errors.api || "Please fix errors and try again.",
        });
      ...
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 px-6 py-4 gap-4">
            ...
            <div>
              ...
              {formData.owner_phone &&
                !phonePattern.test(formData.owner_phone.replace(/\s/g, "")) && (
                  <p className="text-red-500 text-sm mt-1 flex items-center gap-1">
                    <AlertCircle className="w-4 h-4" />
                    Invalid number — must be 10 digits and start with 6–9
                  </p>
        ...
        >
          ...
          {formData.addresses.map((item, index) => (
            ...
            >
              ...
              <div>
                {renderAddressLabel("address", "Address Line")}
                <input
                  type="text"
                  value={item.address}
                  onChange={(e) =>
        ...
        <motion.div variants={itemVariants} className="flex items-center gap-4">
          <div className="flex-1 text-right">
            ...
            <button
              type="submit"
              className={`bg-blue-600 text-white px-6 py-2 rounded-lg shadow transition-all duration-200 ${
                isSubmitting
