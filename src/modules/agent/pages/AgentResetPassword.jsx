...
import { useAgentForgotPassword } from "../agenthooks/useAgentForgotPassword";
            ...
            <div className="text-center py-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full py-3 px-4 bg-gradient-to-r from-teal-600 via-cyan-600 to-blue-600 text-white rounded-lg font-semibold hover:opacity-90 transition"
                >
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-gray-800">
            Create New Agent Password
          </h1>
          <p className="text-gray-600 mt-2">
            Please create a new secure password for your agent account
          </p>
        </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 hover:border-gray-400 transition"
                />
                <button
                  type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-400 transition ${
            ...
            <button
              ...
              className={`w-full py-3 px-4 rounded-lg font-semibold text-white transition-all duration-200 ${
                ...
                newPassword !== confirmPassword
                  ...
                  : "bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 hover:from-green-700 hover:via-emerald-700 hover:to-teal-700 hover:shadow-lg"
              }`}
            >
              {loading ? (
